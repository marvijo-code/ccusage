...
use crate::{
    Align, BucketKind, Color, LoadedEntry, Result, SimpleTable, cli::AgentReportKind,
    cli::SharedArgs, cli::WeekDay, format_currency, format_models_multiline, format_number,
    json_value_u64, print_box_title, should_use_compact_layout, summarize_by_key,
